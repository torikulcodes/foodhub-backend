...
var createProduct = async (data, user) => {
  ...
  if (existProduct) {
    throw new app_error_default("Product already exists", 400);
  }
  let dietIds = [];
